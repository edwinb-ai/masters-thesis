...
\begin{table}
    ...
    \begin{tabular}{|c|c|c|}
    \hline
    \(\phi\)  & Parameters \(\left(\alpha, \beta\right)\)  & Fitness (minimum)    \\ \hline
    ...
    \end{tabular}%
    \caption{Results obtained directly from the optimization procedure for different values of density, \(\phi\). Here, the fitness or minimum represents the best value of \(\Delta \chi^{-1}_{T}\) that satisfies the condition \(\Delta \chi^{-1}_{T} \leq 0.5\).}
...
\begin{table}[]
    ...
    \hline
    \(\phi\)  & Parameters \(\left(\alpha, \beta\right)\)     & Minimum & \({\chi^{v}_{T}}^{-1}\) (Virial)  & \({\chi^{c}_{T}}^{-1}\) (Compressibility)  \\ \hline
    0.10 & [-1.39, 9.82]   & \num{4.26e-11}  & 2.19777  & 2.19778 \\ \hline
    0.15 & [-3.14, 18.08]  & \num{3.11e-11}  & 3.262042 & 3.262047  \\ \hline
    0.20 & [-1.30, 4.84]   & \num{2.60e-10}  & 4.7968  & 4.7969  \\ \hline
    0.25 & [-8.99, 35.01]  & \num{3.71e-11}  & 7.27501   & 7.27502 \\ \hline
    0.30 & [-12.32, 41.06] & \num{3.71e-9}   & 10.9657 & 10.9658 \\ \hline
    0.35 & [-16.88, 49.74] & \num{1.19e-8}   & 16.6411 & 16.6410 \\ \hline
    0.40 & [-27.37, 73.14] & \num{1.91e-8}   & 25.4916 & 25.4914 \\ \hline
    0.45 & [-28.81, 71.35] & \num{2.94e-7}   & 39.0226  & 39.0221  \\ \hline
    \end{tabular}
