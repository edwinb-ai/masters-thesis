...
dynamics suffer greatly. The information that they gather is minimal, but their training 
dynamics shed some light into the possibilities of using probability methods to approximate
