...
\begin{figure}
    \centering
    \includegraphics[scale=0.4]{figuras/capitulo-3/perceptron.pdf}
...
\begin{figure}
    \centering
    \includegraphics[scale=0.6]{figuras/capitulo-3/tres-capas.pdf}
...
method, which in general is a small number, \(\lambda \approx 20 - 35\).~\cite{wierstraNaturalEvolutionStrategies2014a}
