...
are initialized as $\theta_{ij} \sim \mathcal{U} \left[ -\frac{6}{\sqrt{(in + out)}}, \frac{6}{\sqrt{(in + out)}} \right]$,
...
% TODO: Escribir sobre los parámetros empleados para hacer la simulación, cómo se hizo la simulación, qué técnica, y todo lo necesario para reproducir los resultados. Puede ser una nueva subsección, o renombrar esta subsección a algo más general y que solamente sea un párrafo largo.
