...
%%
\chapter{Neural networks as an approximation of the bridge function} % Main chapter title
...
which means that they effectively can be used as powerful interpolators for some specific
types of architectures.
In particular, it is expected of a neural network to be useful as a bridge function
parametrization in the closure expression for the Ornstein-Zernike equation. With this,
we avoid choosing a particular approximation for a given interaction potential, and we
leave the choice of the bridge function to the neural network itself, while
