...
i.e. they can take the form of any continuous function for some specific
network topologies.
...
\begin{enumerate}[(a)]
    ...
    \item If is is possible, how good is the quality of the approximation for the pseudo hard sphere potential?
\end{enumerate}
...
among differente routes has been achieved.
...
Even so, there is no way to enforce thermodynamic self-consistency when using such
...
dynamics suffer greatly. The information that these models gather throughout the training 
