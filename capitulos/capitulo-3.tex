...
Para resolver la ecuación de OZ se empleó un radio de corte $r_c=7.0\sigma$, donde $\sigma$
es el diámetro de las partículas, y tiene por valor $\sigma=1$.
El potencial empleado fue el de pseudo-esferas duras, tanto para la solución de la ecuación
de OZ como para los resultados obtenidos de simulación por computadora.

Se exploraron densidades $\phi \in [0.15, 0.45]$, con $\Delta \phi = 0.05$. Por cada valor
