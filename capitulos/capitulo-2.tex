...
follows. If there is a system of $N$ interacting particles, it happens that each of them
are related to each other. There exists a \emph{direct} relation between particles and
...
\emph{indirect correlation function} that "measures" the direct correlations between
...
\end{equation}
%%TODO: Mencionar función puente, cerraduras y algunas soluciones analíticas, como Percus-Yevick. También mencionar la cerradura de Verlet modificada y Kinoshita, ya que son fundamentales para la tesis. Con esto debe cerrar este marco teórico.